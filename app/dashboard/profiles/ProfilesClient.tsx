...
import { Plus, Trash2, Download, Loader2, Wifi, PowerOff, XCircle, ChevronsUpDown, Check } from "lucide-react";
...
  }, [toast]);
  ...
  useEffect(() => {
    fetchProfiles('active', validUsersPage, validUsersFilter);
  }, [validUsersPage, validUsersFilter, fetchProfiles]);

  useEffect(() => {
    fetchProfiles('revoked', revokedUsersPage, revokedUsersFilter);
  }, [revokedUsersPage, revokedUsersFilter, fetchProfiles]);
...
      });
      ...
      fetchProfiles('active', 1, validUsersFilter);
