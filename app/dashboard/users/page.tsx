  ...
  // 1. Memperbarui State untuk Edit Data
  type EditDataState = {
    role: Role;
  ...
  export default function UserManagementPage() {
    ...
    // Menginisialisasi state dengan field baru
    ...
    const handleEditClick = (user: SafeUser) => {
      setUserToEdit(user);
      // Mereset state saat dialog edit dibuka
      setEditData({
        role: user.role,
        currentPassword: "",
        newPassword: "",
    ...
    // 2. Memperbarui Logika Update User
      ...
      try {
        ...
        if (editData.newPassword) {
          if (!editData.currentPassword) {
            ...
            setIsSubmitting(false); // Hentikan proses jika password saat ini kosong
            return;
          }
        ...
        >
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              ...
              {/* 3. Menambahkan Input Field Baru di Dialog */}
              <div className="grid grid-cols-4 items-center gap-4">
